...
function () {
  ...
  _createClass(Message, [{
    ...
    value: function output() {
      var withTime = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
      return withTime ? "[".concat(new Date().toLocaleString(), "] ").concat(this.body) : this.body;
    }
  }]);
...
var _Translator = _interopRequireDefault(__webpack_require__(25));
...
var _Information = _interopRequireDefault(__webpack_require__(27));

var _Result = _interopRequireDefault(__webpack_require__(28));

var _Connection = _interopRequireDefault(__webpack_require__(29));
...
function () {
  function Translator() {
    ...
    this.input = new _Input.default('#sound', this);
    this.information = new _Information.default('#info', this);
    this.result = new _Result.default('#result', this);
  ...
  _createClass(Translator, [{
    ...
    key: "upload",
    value: function upload(fileElement) {
      this.connection.upload(fileElement);
    }
  }, {
    key: "message",
    value: function message(_message) {
      if (_message.type === 'information') {
        return this.information.output(_message.output());
      }

      if (_message.type === 'result') {
        return this.result.output(_message.output(false));
      }

      if (_message.type === 'error') {
        throw new Error(_message.output());
      }
    }
  }]);
...
/*#__PURE__*/
function () {
  function Input(selector, translator) {
  ...
  _createClass(Input, [{
    ...
    value: function onChange(e) {
      this.upload();
      this.translator.message(new _Message.default('information', 'Uploading File...'));
    }
  }, {
    key: "upload",
...
/*#__PURE__*/
function () {
  function Information(selector, translator) {
  ...
  _createClass(Information, [{
    ...
    value: function output(data) {
      ...
      p.innerHTML = _typeof(data) === 'object' ? JSON.stringify(data) : data;
...
/*#__PURE__*/
function () {
  function Result(selector, translator) {
...
var _socket = _interopRequireDefault(__webpack_require__(30));

var _socket2 = _interopRequireDefault(__webpack_require__(55));
...
/*#__PURE__*/
function () {
  function Connection(translator) {
  ...
  _createClass(Connection, [{
    key: "init",
    value: function init() {
      this.io = (0, _socket.default)('http://localhost:3000/');
      this.uploader = new _socket2.default(this.io);
      this.attach();
    }
  }, {
    key: "attach",
    ...
    key: "onInformation",
    value: function onInformation(data) {
      this.translator.message(new _Message.default('information', data.message));
    }
  }, {
    key: "onResult",
    value: function onResult(result) {
      this.translator.message(new _Message.default('result', result.message));
    }
  }]);
